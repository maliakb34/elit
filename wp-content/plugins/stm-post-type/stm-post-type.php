...
define( 'STM_POST_TYPE_DB_VERSION', '1.0.5' );
define( 'STM_POST_TYPE_PLUGIN_VERSION', '3.8.2' );
...
function stm_plugin_styles() {
	wp_enqueue_style( 'nuxy-styles', STM_POST_TYPE_URL . '/theme-options/inc/assets/css/styles.css', null, '4.1.5.1', 'all' );

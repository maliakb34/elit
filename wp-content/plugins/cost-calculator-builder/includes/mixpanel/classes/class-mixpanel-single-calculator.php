...
//phpcs:ignore		self::add_data( 'Single PayPal Enabled', self::get_payment_methods( 'paypal' ) );
//phpcs:ignore		self::add_data( 'Single Stripe Enabled', self::get_payment_methods( 'stripe' ) );

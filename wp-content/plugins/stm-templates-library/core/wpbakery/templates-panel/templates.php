...
function getTemplates() {
	return array(
		...
		'Coming Soon Page'          => array(
			'id'      => 'templates-miscellaneous',
			'image'   => 'coming_soon.jpg',
			'url'     => 'https://consulting.stylemixthemes.com/coming-soon/',
			'content' => file_get_contents( plugin_dir_path( __FILE__ ) . 'files/miscellaneous/coming_soon.json', true ),
		),
		'404 Page'                  => array(
			'id'      => 'templates-miscellaneous',
			'image'   => '404.jpg',
			'url'     => 'https://consulting.stylemixthemes.com/404',
			'content' => file_get_contents( plugin_dir_path( __FILE__ ) . 'files/miscellaneous/404.json', true ),
		),
	);

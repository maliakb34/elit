...
class Elementor_STM_MyDoc extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'My Documents', 'consulting-elementor-widgets' );
	}
	...
	protected function render() {
		if ( function_exists( 'consulting_show_template' ) ) {
			...
			$settings['css_class'] = ' consulting_elementor_MyDoc';

<div id="ai-buddy-feedback-modal" class="ai-buddy-feedback-modal">
	<div class="feedback-modal-content">
		...
		<div class="feedback-extra">
			...
			<small><?php echo esc_html__( 'Found a bug in the plugin?', 'aibuddy-openai-chatgpt' ); ?> <a href="<?php echo esc_url( 'https://wordpress.org/support/plugin/aibuddy-openai-chatgpt/' ); ?>" target="_blank" rel="nofollow"><?php echo esc_html__( 'Click here', 'aibuddy-openai-chatgpt' ); ?></a>

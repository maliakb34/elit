<?php require AI_BUDDY_PATH . '/includes/admin/api-key-first-screen.php'; ?>
<form id="topic-form">
						...
						<div class="drop-down-box-wrapper">
							...
							<div class="drop-down-box">
								<div class="drop-down-column">
									<select id="count-post-section" class="dependent-fields ai-buddy-select" title="count-post-section" disabled>
				...
				<div class="section" id="post-content-box">
					...
					<div class="section-content">
						<div class="drop-down-box-wrapper">
							...
							<div class="drop-down-box">
								<div class="drop-down-column">
									<select id="count-post-content" class="dependent-fields ai-buddy-select" title="count-post-content" disabled>

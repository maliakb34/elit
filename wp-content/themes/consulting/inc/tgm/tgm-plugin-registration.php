...
function consulting_require_plugins( $return = false ) {
	$stm_importer_ver          = '6.1.2';
	$stm_post_type_ver         = '3.8.2';
	$revslider_ver             = '6.6.20';
	$js_composer_ver           = '7.3';
	$elementor_widgets_ver     = '1.2.7';
	$stm_templates_library_ver = '1.4';
	...
	$plugins = array(
		...
		'aibuddy-openai-chatgpt'       => array(
			'name'     => 'AiBud WP - ChatGPT, OpenAI, Content & Image Generator WordPress plugin',

...
if ( $elementor_status ) {
	$classes = 'consulting_elementor_wrapper';
}

get_template_part( 'inc/popups/main' ); ?>

<article id="post-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>

	<div class="entry-content">
		<?php if ( $vc_status != 'false' && $vc_status == true || $is_shop ) { ?><?php the_content(); ?><?php } else if ( $elementor_status ) {// phpcs:ignore ?>
